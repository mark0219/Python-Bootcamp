...
#Your code goes here
dc_num = raw_input('Please enter a DC identification number: ')
dc_num = int(dc_num)
#results = [t for t in assign if t[0] == dc_num]

print
print "Stores assigned to DC", dc_num, "located at", dcs[dc_num]
print "-----------------------------------------------------------"

for x in [t for t in assign if t[0] == dc_num]:
    print "Store", x[1], ",", stores[x[1]]